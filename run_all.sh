...
python3 scripts/run.py --library BSP --threshold 0 -e 4 -c outdoors -b 2 -n 'BSP-Bx2' && \ 
python3 scripts/run.py --library BSP --threshold 0 -e 8 -c outdoors -b 4 -n 'BSP-Bx4' && \ 
python3 scripts/run.py --library SSP --threshold 4 -e 2 -c outdoors -b 1 -n 'SSP-Bx1' && \ 
python3 scripts/run.py --library SSP --threshold 4 -e 4 -c outdoors -b 2 -n 'SSP-Bx2' && \ 
python3 scripts/run.py --library SSP --threshold 4 -e 8 -c outdoors -b 4 -n 'SSP-Bx4' && \
python3 scripts/run.py --library ROG --threshold 4 -e 2 -c outdoors -b 1 -n 'ROG-Bx1' && \ 
python3 scripts/run.py --library ROG --threshold 4 -e 4 -c outdoors -b 2 -n 'ROG-Bx2' && \ 
python3 scripts/run.py --library ROG --threshold 4 -e 8 -c outdoors -b 4 -n 'ROG-Bx4' && \ 
python3 scripts/test_checkpoints_on_server.py && \
